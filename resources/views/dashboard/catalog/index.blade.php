...
@section('content')
    <section class="flex flex-wrap justify-between items-start gap-2 mb-2">
        ...
        <a href="{{ route('dashboard.catalog.create') }}" class="text-sm bg-light text-gray-800 px-3 py-1 rounded-md">
                        ...
                        <td class="px-2 pt-1 pb-2 align-top">
                            <div class="flex justify-center flex-wrap gap-2">
                                @foreach ($item->catalogItems as $citem)
                                    <span
                                        class="bg-blue-400 text-white rounded-full px-3 py-1 text-center">{{ $citem->item->name }}
                                        x
                                        {{ $citem->qty }}</span>
                                @endforeach
                            </div>
