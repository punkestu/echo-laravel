...
@section('content')
    ...
    <section class="mt-6">
        <form action="{{ route('dashboard.discount.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="customer" id="customer"
                    class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Masukan nama / no hp customer" value="{{ old('customer') }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="discount_amount" id="discount_amount"
                    class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Masukkan harga" value="{{ old('discount_amount') }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="discount_percentage" id="discount_percentage"
                    class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Masukkan harga" value="{{ old('discount_percentage') }}" max="100" min="0">
