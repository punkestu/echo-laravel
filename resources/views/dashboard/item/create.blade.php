            ...
            <div class="mb-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="flex-grow">
                    ...
                    <input type="number" name="qty" id="qty" required
                        class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan jumlah total item" value="{{ old('qty') }}">
                    @if ($errors->has('qty'))
                ...
                <div class="flex-grow">
                    ...
                    <input type="number" name="good_qty" id="good_qty" required
                        class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan jumlah total item bagus" value="{{ old('good_qty') }}">
                ...
                <div class="flex-grow">
                    ...
                    <input type="number" name="bad_qty" id="bad_qty" required
                        class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan jumlah total item rusak" value="{{ old('bad_qty') }}">
                ...
                <div class="flex-grow">
                    ...
                    <input type="number" name="rent_qty" id="rent_qty" required
                        class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan jumlah total item disewa" value="{{ old('rent_qty') }}">
            ...
            <div class="mb-4 flex gap-4">
                <div class="flex-grow">
                    ...
                    <input type="number" name="base_price" id="base_price" required
                        class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan harga normal" value="{{ old('base_price') }}">
                ...
                <div class="flex-grow">
                    ...
                    <input type="number" name="price" id="price" required
                        class="px-2 py-1 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Masukkan harga sekarang" value="{{ old('price') }}">
                    @if ($errors->has('price'))
