...
class OrderController
{
    ...
    public function edit($id)
    {
        ...
        $status_disabled = [
            ...
            'DP' => ['name', 'nohp', 'alamat', 'catalogs', 'dp'],
            'diproses' => ['name', 'nohp', 'alamat', 'catalogs', 'dp'],
            'dibawa' => ['name', 'nohp', 'alamat', 'catalogs', 'dp', 'jaminan', 'pengambilan', 'tempat_cod', 'jam_ambil', 'jam_kembali'],
            'dikembalikan' => ['name', 'nohp', 'alamat', 'catalogs', 'dp', 'jaminan', 'pengambilan', 'tempat_cod', 'jam_ambil'],
            'selesai' => ['name', 'nohp', 'alamat', 'catalogs', 'dp', 'jaminan', 'pengambilan', 'tempat_cod', 'jam_ambil'],
            'batal' => ['name', 'nohp', 'alamat', 'catalogs', 'dp', 'jaminan', 'pengambilan', 'tempat_cod', 'jam_ambil'],
        ];
    ...
    public function store(Request $request)
    {
        ...
        $catalogs_id = array_map(
            function ($catalog) {
                return $catalog['id'];
            },
            $request->catalogs
        );
        $price = Catalog::whereIn('id', $catalogs_id)->sum('price');
        $order = Order::create([
    ...
    public function update(Request $request, $id)
    {
        ...
        } else if ($order->status == 'DP' || $order->status == 'diproses') {
            $validation = validator($request->only([
                'jaminan' => ['required', new Enum(Jaminan::class)],
                'pengambilan' => ['required', new Enum(Pengambilan::class)],
                'tempat_cod' => 'nullable|string|max:255',
